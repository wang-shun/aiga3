    ...
    var Query = {
            ...
            addPropertyConfig: function() {
                ...
                _addBt.bind('click', function() {
                    ...
                    //
                    $(Dom.addPropertyConfigModal).modal.Constructor.prototype.enforceFocus = function() {}; Utils.setSelectData(_form);
                    var _saveBt = $(Dom.addPropertyConfigModal).find("[name = 'save']"); _saveBt.unbind('click'); _saveBt.bind('click', function() {
