...
<div class="row">
    ...
    <div class="hide col-sm-6 form-group">
        <label class="col-sm-4 control-label"><i class="text-red">* </i>创建人：</label>
        <div class="col-sm-8">
...
<div class="row">
    <div class="form-group col-sm-6">
        <label class="col-sm-4 control-label"><i class="text-red">* </i>执行类型：</label>
        <div class="col-sm-8">
...
<div class="row" id="Js_cycleInput">
    <div class="col-sm-6 form-group">
        <label class="col-sm-4 control-label"><i class="text-red">* </i>轮循间隔时间：</label>
        <div class="col-sm-8">
            <input type="text" class="form-control input-sm" name="intervalTime" value="1">
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-3 form-group form-inline">
        ...
        <input type="text" class="form-control input-sm" name="parallelType" value="1" style="width: 50px">
    </div>
    <div id="inputSmsType" class="col-sm-3 form-group form-inline">
