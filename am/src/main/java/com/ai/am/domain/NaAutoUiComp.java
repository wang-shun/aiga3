...
public class NaAutoUiComp {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE,generator="NA_AUTO_UI_COMP$SEQ")
    @SequenceGenerator(name="NA_AUTO_UI_COMP$SEQ",sequenceName="NA_AUTO_UI_COMP$SEQ",allocationSize=1)
    @Column(name = "RELA_ID")
