...
public class QuartzManager {  
    ...
    public static void addJob(String jobName,String param, String clzName, String time) {  
        try {  
            Class<? extends Job> quartzJob = QuartzJob.class;  
            ...
            // 放入参数，运行时的方法可以获取  
            jobDetail.getJobDataMap().put("jobPara", param);  
            jobDetail.getJobDataMap().put("jobClass", clzName);  
            // 表达式调度构建器  
