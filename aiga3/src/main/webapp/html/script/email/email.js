define(function(require, exports, module) {
    ...
    var Query = {
        ...
        sendEmail: function() {
            ...
            _send.bind('click', function() {
                self.checkForm($(Dom.emailForm), function() {
                    ...
                    var files = _form.find("[name='attachment']").val();
                    alert(typeof markupStr);
                    alert(markupStr);
                    alert(Rose.htmlFilter(markupStr));
        ...
        getOnlineTaskList: function(cmd) {
            ...
            XMS.msgbox.show('数据加载中，请稍候...', 'loading');
            Rose.ajax.postJson(srvMap.get('send'), _cmd, function(json, status) {
                if (status) {
