define(function(require, exports, module) {
	...
	//查询接口
	srvMap.add("query2day", "", "arch/numberflow/query2day");
	//查询接口
	...
	var init = {
		...
		_getGridList: function(cmd){
			...
			var _cmd2 = {
    			endMonth:stime,
    			indexId:[[1030001,1030002,1030003,1030004,1030005,1030006,1030007,1030008,1030009,1030010,1030011,1030013,1030014,1030015,1030016,1030017,1030018,1030019,1030020,1030021,1030022,1030023,1030024,1030025,1030026,1030027,1030028,1030029,1030030,1030031,1030032,1030033,1030034,1030035,1030036,1030037,1030038],
    			[1031001,1031002,1031003,1031004,1031005,1031006,1031007,1031008,1031009,1031010,1031011,1031013,1031014,1031015,1031016,1031017,1031018,1031019,1031020,1031021,1031022,1031023,1031024,1031025,1031026,1031027,1031028,1031029,1031030,1031031,1031032,1031033,1031034,1031035,1031036,1031037,1031038],
    			[1032001,1032002,1032003,1032004,1032005,1032006,1032007,1032008,1032009,1032010,1032011,1032013,1032014,1032015,1032016,1032017,1032018,1032019,1032020,1032021,1032022,1032023,1032024,1032025,1032026,1032027,1032028,1032029,1032030,1032031,1032032,1032033,1032034,1032035,1032036,1032037,1032038],
    			[1033001,1033002,1033003,1033004,1033005,1033006,1033007,1033008,1033009,1033010,1033011,1033013,1033014,1033015,1033016,1033017,1033018,1033019,1033020,1033021,1033022,1033023,1033024,1033025,1033026,1033027,1033028,1033029,1033030,1033031,1033032,1033033,1033034,1033035,1033036,1033037,1033038]]
			};
			Rose.ajax.postJson(srvMap.get('query2day'),_cmd2,function(json, status){
				if(status) {
	        		...
	        		tablebtn.find("[class='btn btn-primary btn-table-detail7']").off('click').on('click', function() {
	        			...
	        			if(db=='ZJCRMA'){
	        				_ggcmd.indexId=[1030001,1030002,1030003,1030004,1030005,1030006,1030007,1030008,1030009,1030010,1030011,1030013,1030014,1030015,1030016,1030017,1030018,1030019,1030020,1030021,1030022,1030023,1030024,1030025,1030026,1030027,1030028,1030029,1030030,1030031,1030032,1030033,1030034,1030035,1030036,1030037,1030038];
	        			}else if(db=='ZJCRMB'){
	        				_ggcmd.indexId=[1031001,1031002,1031003,1031004,1031005,1031006,1031007,1031008,1031009,1031010,1031011,1031013,1031014,1031015,1031016,1031017,1031018,1031019,1031020,1031021,1031022,1031023,1031024,1031025,1031026,1031027,1031028,1031029,1031030,1031031,1031032,1031033,1031034,1031035,1031036,1031037,1031038];
	        			}else if(db=='ZJCRMC'){
	        				_ggcmd.indexId=[1032001,1032002,1032003,1032004,1032005,1032006,1032007,1032008,1032009,1032010,1032011,1032013,1032014,1032015,1032016,1032017,1032018,1032019,1032020,1032021,1032022,1032023,1032024,1032025,1032026,1032027,1032028,1032029,1032030,1032031,1032032,1032033,1032034,1032035,1032036,1032037,1032038];
	        			}else if(db=='ZJCRMD'){
	        				_ggcmd.indexId=[1033001,1033002,1033003,1033004,1033005,1033006,1033007,1033008,1033009,1033010,1033011,1033013,1033014,1033015,1033016,1033017,1033018,1033019,1033020,1033021,1033022,1033023,1033024,1033025,1033026,1033027,1033028,1033029,1033030,1033031,1033032,1033033,1033034,1033035,1033036,1033037,1033038];
	        			}
