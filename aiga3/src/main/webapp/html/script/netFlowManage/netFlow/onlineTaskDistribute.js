        ...
        addOnlineTask: function() {
            ...
            _save.bind('click', function() {
                ...
                if (data) {
                    ...
                    var autoPlanId = _form.find("[name='autoPlanId']").val();
                    ...
                    if (taskName != "" && autoPlanId != "" && dealOpId != "") {
        ...
        updateOnlineTask: function() {
            ...
            _update.bind('click', function() {
                ...
                if (dataTemp) {
                    ...
                    _form.find("[name='autoPlanId']").val(dataTemp.autoPlanId);
            ...
            _del.bind('click', function() {
                ...
                if (data) {
                    ...
                    if (_data) {
                        ...
                        var cmd = "onlinePlanId=" + data.onlinePlanId + "&taskIds=" + _taskIdsArray.join(",");
                        console.log(cmd);
