        ...
        <tr>
            ...
            <td>
                <div class="text-center">
                    <button type="button" class="btn btn-primary" id="publish" name="publish">编译发布</button>
                    <button type="button" class="btn btn-primary" id="rollback" name="rollback">回退</button>
                </div>
            </td>
        </tr>
    {{/each}}
