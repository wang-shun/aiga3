...
public class AigaFunFolderRequest {
	...
	public String toString() {
		return "AigaFunFolderRequest [funId=" + funId + ", sysName=" + sysName + ", createTime=" + createTime
				+ ", updateTime=" + updateTime + ", sysId=" + sysId + ", busiLabel=" + busiLabel + ", baseFunLabel="
				+ baseFunLabel + ", dataCheckScript=" + dataCheckScript + ", importantClass=" + importantClass
				+ ", menuPath=" + menuPath + ", funType=" + funType + ", funDesc=" + funDesc + ", isInvalid="
				+ isInvalid + ", addReasonType=" + addReasonType + ", addReason=" + addReason + ", efficiencyTestType="
				+ efficiencyTestType + ", isEfficiencyTest=" + isEfficiencyTest + ", devFirm=" + devFirm
				+ ", sysIdTemp=" + sysIdTemp + ", subSysId=" + subSysId + ", subSysIdTemp=" + subSysIdTemp
				+ ", operatorId=" + operatorId + ", operatorName=" + operatorName + ", creatorId=" + creatorId
