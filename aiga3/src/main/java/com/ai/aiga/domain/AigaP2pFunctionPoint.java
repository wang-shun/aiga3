...
// Generated 2017-2-14 14:50:51 by Hibernate Tools 3.2.2.GA
...
public class AigaP2pFunctionPoint implements java.io.Serializable {
	...
	public AigaP2pFunctionPoint(BigDecimal funId, String sysName, Date createTime, Date updateTime, String cause,
			Short causeType, BigDecimal operatorId, String operatorName, BigDecimal creatorId, String creatorName,
			BigDecimal status, BigDecimal verifyStatus, String verifyResult) {
		this.funId = funId;
