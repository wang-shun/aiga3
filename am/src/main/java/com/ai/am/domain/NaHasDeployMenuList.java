...
/**
 * NaHasDeployMenuList generated by hbm2java
 */
@Entity
@Table(name="NA_HAS_DEPLOY_MENU_LIST")
public class NaHasDeployMenuList  implements java.io.Serializable {
    ...
    public NaHasDeployMenuList() {
    }

	
    public NaHasDeployMenuList(Long id) {
        this.id = id;
    }
    public NaHasDeployMenuList(Long id, String devTaskId, String requireName, String testMan, String requireMan, String hasDeploy, String ext1, String ext2, String ext3, Long planId) {
       this.id = id;
     ...
     @Id 
     @GeneratedValue(strategy=GenerationType.SEQUENCE,generator="NA_HAS_DEPLOY_MENU_LIST$SEQ")
     @SequenceGenerator(name="NA_HAS_DEPLOY_MENU_LIST$SEQ",sequenceName="NA_HAS_DEPLOY_MENU_LIST$SEQ",allocationSize=1)
    ...
    @Column(name="HAS_DEPLOY", length=200)
    public String getHasDeploy() {
        return this.hasDeploy;
    }
    
    public void setHasDeploy(String hasDeploy) {
        this.hasDeploy = hasDeploy;
    }
