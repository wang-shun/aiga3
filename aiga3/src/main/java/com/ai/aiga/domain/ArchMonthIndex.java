 ...
 */
@Entity
@Table(name="ARCH_MONTH_INDEX")
public class ArchMonthIndex  implements java.io.Serializable {
    ...
    public ArchMonthIndex(){
    }

	public ArchMonthIndex(Long indexId, String settMonth, String key1, String key2,
	...
	public ArchMonthIndex(Long indexId, String settMonth, String key1,
			String key2, String key3, String resultValue, Long groupId, Date insertTime) {
		super();
		this.indexId = indexId;
		this.settMonth = settMonth;
		this.key1 = key1;
