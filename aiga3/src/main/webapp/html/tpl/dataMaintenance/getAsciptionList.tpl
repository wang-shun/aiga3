<div class="box-header ">
    ...
    <div class="box-tools">
        <div class="btn-group">
          <button type="button" class="btn btn-success" name="add" ><i class="fa fa-hourglass-end"></i> 新增</button>
          <button type="button" class="btn btn-danger" name="del"><i class="fa fa-remove"></i> 删除所选条目</button>
        </div>
    </div>
</div>
<div class="box-body" >
