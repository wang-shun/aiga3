...
/**
 * <p>Java class for AddTaskByFileRsp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddTaskByFileRsp">
 *   &lt;complexContent>
...
@XmlType(name = "AddTaskByFileRsp", propOrder = {
    "error",
    "resultCode",
    "resultFileName"
})
public class AddTaskByFileRsp {
    ...
    @XmlElementRef(name = "resultFileName", namespace = "http://domain.server.mmap.msp.huawei.com", type = JAXBElement.class)
    protected JAXBElement<String> resultFileName;
     ...
     *     
     */
    public JAXBElement<String> getResultFileName() {
     ...
     *     
     */
    public void setResultFileName(JAXBElement<String> value) {
        this.resultFileName = ((JAXBElement<String> ) value);
    }
