package com.ai.am.view.controller.plan.dto;

import java.util.Date;

public class PlanDetailManifestExcel implements java.io.Serializable {
	...
	public PlanDetailManifestExcel() {
	}
	...
	public String toString() {
		return "PlanDetailManifestExcel [qaProgress=" + qaProgress + ", qaSituation=" + qaSituation + ", qaStaff="
				+ qaStaff + ", qaManager=" + qaManager + ", qaBugNumber=" + qaBugNumber + ", reqDate=" + reqDate
				+ ", reqNo=" + reqNo + ", reqName=" + reqName + ", reqOrigin=" + reqOrigin + ", reqLevel=" + reqLevel
				+ ", reqPriority=" + reqPriority + ", reqGroupFocus=" + reqGroupFocus + ", reqCategory=" + reqCategory
				+ ", reqType=" + reqType + ", reqUpdateType=" + reqUpdateType + ", reqUpdate=" + reqUpdate
				+ ", reqReason=" + reqReason + ", reqFirstDate=" + reqFirstDate + ", reqLastDate=" + reqLastDate
				+ ", reqOnlineDate=" + reqOnlineDate + ", devNo=" + devNo + ", devName=" + devName + ", devStatus="
				+ devStatus + ", reqImportant=" + reqImportant + ", sysName=" + sysName + ", subSysName=" + subSysName
				+ ", qaTeam=" + qaTeam + ", devStaff=" + devStaff + ", devManager=" + devManager + ", reqManager="
				+ reqManager + ", reqStaff=" + reqStaff + ", remarks=" + remarks + ", devWorkload=" + devWorkload
				+ ", devAnalyse=" + devAnalyse + ", reqSkippingCycle=" + reqSkippingCycle + ", qaCrossSystem="
				+ qaCrossSystem + ", reqGroup=" + reqGroup + ", devDataScript=" + devDataScript + ", reqRollback="
				+ reqRollback + ", reqRollbackMode=" + reqRollbackMode + ", reqRbCostTime=" + reqRbCostTime + "]";
	}
